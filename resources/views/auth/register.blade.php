        ...
        <div class="container">
            <div class="signup-content">
                <div class="signup-form">
                    ...
                    <form method="POST" class="register-form" id="register-form" action="{{ route('register') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input id="email" type="email" placeholder="Your Email" @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email">
                        ...
                        <div class="form-group">
                            ...
                            <input id="address" placeholder="Address" @error('address') is-invalid @enderror" name="address" required autocomplete="Address">
                ...
                <div class="signup-image">
                    ...
                    <a href="/login" class="signup-image-link" style="color:Red">I am already member</a>
                </div>
            </div>
        </div>
    </section>
